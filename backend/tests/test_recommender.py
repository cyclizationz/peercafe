...
class TestRestaurantRecommenderUnit:
    ...
    def recommender(self, mock_env, mock_supabase_client, mock_groq_client):
        ...
        with patch('utils.restaurant_recommender.create_supabase_client', return_value=mock_supabase_client), \
    ...
    def test_search_by_cuisine(self, recommender, mock_restaurants):
        ...
        mock_response = Mock()
        mock_response.data = [r for r in mock_restaurants if 'Italian' in r['cuisine_type']]
    ...
    def test_search_multiple_filters(self, recommender, mock_restaurants):
        ...
        filtered = [r for r in mock_restaurants 
    ...
    def test_get_recommendations_with_function_call(self, recommender, mock_restaurants):
        ...
        recommender.client.chat.completions.create.side_effect = [first_response, final_response]
        
        # Mock the search_restaurants method to return data
        recommender.search_restaurants = Mock(return_value=[mock_restaurants[0]])
        
        # Run the recommendation
        result = recommender.get_recommendations("I want Italian food with veggie options")
...
class TestRestaurantRecommenderIntegration:
    ...
    def test_real_api_simple_query(self, recommender, sample_restaurants):
        ...
        assert 'italian' in result_lower or 'restaurant' in result_lower or 'bella' in result_lower
    ...
    def test_real_api_with_function_calling(self, recommender, sample_restaurants):
        ...
        result_lower = result.lower()
        assert any(word in result_lower for word in ['vegetarian', 'veggie', 'green', 'garden', 'restaurant'])
    ...
    def test_real_api_response_quality(self, recommender, sample_restaurants):
        ...
        assert any(word in result_lower for word in ['restaurant', 'recommend', 'suggest'])
