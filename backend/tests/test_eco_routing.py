...
@pytest.mark.asyncio
async def test_eco_endpoint_single_closest_order(client, monkeypatch):
...
@pytest.mark.asyncio
async def test_eco_endpoint_group_orders(client, monkeypatch):
...
@pytest.mark.asyncio
async def test_ready_orders_endpoint(client, monkeypatch):
